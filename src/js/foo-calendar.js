/**
 * Created by krimeshu on 2016/3/14.
 */
(function () {
    ...
    //$(function () {
        ...
        res.direction = directions[random(iday, 2) % directions.length];
        res.drink = pickRandom(drinks, 2);
        res.goddes = star(random(iday, 6) % 5 + 1);
